...
class Setting extends Model
{
    ...
    protected $fillable = [
        ...
        'purchase_order_requested_by',
        'purchase_order_verifier1',
        'purchase_order_prepared_by',
        'purchase_order_checker',
        'purchase_order_verifier2',
    ...
    static $logName = [
        ...
        'purchase_order_verifier1' => 'purchase_order_verifier1',
        'purchase_order_checker' => 'purchase_order_checker',
        'purchase_order_verifier2' => 'purchase_order_verifier2'
    ];
