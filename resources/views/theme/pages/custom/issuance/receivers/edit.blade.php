                        ...
                        <div class="card-body">
							...
							<form method="post" action="{{ route('issuance.receivers.update', $receiver->id) }}">
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="address" name="address" value="{{ $receiver->address }}" required>
                                    </div>
								</div>
								<div class="form-group row">
									<label for="name" class="col-sm-2 col-form-label">Contact</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="contact" name="contact" value="{{ $receiver->contact }}" required>
                                    </div>
								</div>
