                        ...
                        <div class="card-body">
							...
							<form method="post" action="{{ route('issuance.transactions.store') }}" enctype="multipart/form-data" onsubmit="return checkSelectedItems();">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" id="ris_number" name="ris_no" class="form-control" autocomplete="off" placeholder="Type to search RIS #" list="ris_number_list" onkeypress="if(event.key === 'Enter') { event.preventDefault(); }">
								...
								<div class="form-group row" hidden>
									<label class="col-sm-2 col-form-label">issuance Agency</label>
									<div class="col-sm-10">
