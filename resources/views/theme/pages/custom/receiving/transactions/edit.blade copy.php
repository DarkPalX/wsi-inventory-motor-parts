											...
											<tbody>
												@foreach($receiving_details as $receiving_detail)
													<tr>
														...
														{{-- <td>{{ number_format($receiving_detail->price, 2) }} <input name="price[]" type="text" value="{{ number_format($receiving_detail->price, 2) }}" hidden></td> --}}
											...
											data.results.forEach(item => {
												resultsTableBody.append(`
													<tr>
														...
														<td><input class="border-0" name="order[]" type="number" value="${item.remaining}" readonly></td>
