...
<div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
    ...
    <div style="padding:30px 60px;">
        ...
        <div style="text-align: center;">
           <a href="{{ URL::to('/reset-password') }}?token=n8uien28j9mh2673ge23e238ye7283ed2iojdfdfigbfdgsdfm83&email={{ urlencode($recipient->email) }}" target="_blank" style="padding: 10px 20px; background: #0349fc; color: #fff; text-decoration: none; font-size: 14px; border-radius: 3px;">Reset my password</a>
        </div>
